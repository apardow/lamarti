      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-10">
            ...
            <Link to="/actividades" className="bg-marti-orange text-white px-8 py-3 rounded-full text-sm font-extrabold shadow-xl hover:bg-marti-red transition-all transform hover:scale-105 active:scale-95">
              ÚNETE AHORA
            </Link>
          </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="pt-8">
                <Link to="/actividades" className="block w-full bg-marti-orange text-white py-5 rounded-2xl text-lg font-extrabold shadow-xl text-center" onClick={() => setIsOpen(false)}>
                  ÚNETE AHORA
                </Link>
              </div>
            </div>
