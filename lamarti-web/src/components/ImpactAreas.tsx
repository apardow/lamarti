      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Trabajamos incansablemente en diversos frentes para construir un
            continente más unido, justo y solidario, siguiendo el legado de los
            grandes pensadores de Nuestra América.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {areas.map((area, i) => (
            ...
            >
              ...
              <div className="p-10">
                <h3 className="text-2xl font-display font-black text-marti-blue mb-4">
                  {area.title}
                </h3>
                ...
                <Link
                  href={area.link}
                  className="text-marti-orange font-black flex items-center gap-2 hover:gap-4 transition-all"
                >
